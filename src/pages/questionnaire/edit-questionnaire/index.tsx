...
const EditQuestionnaire = () => {
    ...
    const { data: questionnaire, isLoading } = useGetQuestionnaireById(
                    ...
                    <Box className={'question'}>
                        ...
                        <FormControl>
                            ...
                            >
                                ...
                                <MenuItem key={2} value={'SINGLE_CHOICE'}>
                                    Una opción
                                </MenuItem>
                                <MenuItem key={3} value={'NOT_A_QUESTION'}>
                                    Comentario
                                </MenuItem>
