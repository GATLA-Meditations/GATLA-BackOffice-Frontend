...
const EditTreatment = () => {
    ...
    const [treatmentDescription, setTreatmentDescription] =
        useState<string>(''); // same as treatment name
    ...
    return (
        <Box className="display-items-page">
            ...
            <Box>
                <h3>Cuestionarios:</h3>
                {treatment.questionnaires.length > 0 ? (
                    treatment.questionnaires.map(
            ...
            <Box>
                <h3>Módulos:</h3>
                <Box className="items">
                    {treatment.modules.length > 0 ? (
                        treatment.modules.map((module: Module) => (
                            <Box
                                key={module.id}
                                className="item"
