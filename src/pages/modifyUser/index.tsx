    ...
    return (
        <Box className={"home-display"}>
            <Box className={styles.activityContainer}>
                <EditableInput title={'Código de usuario'} text={mockUser.code} placeholder={'afeaf'} type={'text'}
                               name={'UserCode'} handleChange={(e) => handleChange('code', e.target.value)}/>
                <EditableInput title={'Contraseña de usuario'} text={mockUser.password} placeholder={'anfeanef'}
